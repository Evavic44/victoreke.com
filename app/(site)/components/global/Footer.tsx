      ...
      <div className="max-w-7xl mx-auto flex lg:flex-row flex-col items-center lg:justify-between justify-center gap-y-4 md:px-16 px-6 py-16">
        <ul className="text-sm flex items-center gap-x-2 dark:text-zinc-600 text-zinc-400">
          ...
          <li>
            ...
            >
              <Image src={sanitylogo} width={20} height={20} alt="sanity" />{" "}
              Sanity
            </a>
          </li>
          •
          <li>
            <a
              ...
              className="flex items-center gap-x-2 dark:text-white text-zinc-600 hover:underline"
            >
              <Image src={nextjslogo} width={20} height={20} alt="sanity" />{" "}
              Next.js
            </a>
          </li>
          •
          <li>
            <a
              ...
              className="flex items-center gap-x-2 dark:text-white text-zinc-600 hover:underline"
            >
              <Image src={vercellogo} width={20} height={20} alt="sanity" />{" "}
              Vercel
            </a>
          </li>
          •
